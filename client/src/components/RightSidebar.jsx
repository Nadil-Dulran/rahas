...
const RightSidebar = () => {
  ...
  //Get all the images from the messages and set them to satate
  useEffect(() => {
    setMsgImages(
  ...
  return selectedUser && (
    <div className={`bg-[#8185a3]/10 text-white w-full relative overflow-y-scroll ${selectedUser ? "max-md:hidden" : ""}`}>


      <div className="pt-16 flex flex-col items-center gap-2 text-xs font-light mx-auto text-blue-400">
