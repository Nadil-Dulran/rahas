...
const Loginpage = () => {
  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-gray-400 border-fray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
      ...
      {currState === "Sign up" && !isDataSubmitted && (
        ...
        type="text" className='p-2 border border-gray-500 rounded-md focus:outline-non' placeholder="Full Name" required/>
      )}
      ...
      {!isDataSubmitted && (
        ...
        {currState === "Sign up" && isDataSubmitted && (
          ...
          rowos={4} className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500' placeholder='Provide a short bio...' required></textarea>
        )
        }
